...
class CustomBottemNavBar extends StatefulWidget {
  const CustomBottemNavBar({super.key});

  @override
  State<CustomBottemNavBar> createState() => _BottemNavBarState();
}

class _BottemNavBarState extends State<CustomBottemNavBar> {
  @override
